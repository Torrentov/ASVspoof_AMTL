...
class MultiTaskResNet(nn.Module):
    def __init__(self,
        resnet_num_nodes, resnet_enc_dim,
        rec_ae_enc_dim,
        conv_ae_num_nodes, conv_ae_enc_dim,
        sc_enc_dim, sc_nclasses,
        resnet_resnet_type='18', resnet_nclasses=2, resnet_dropout1d=False, resnet_dropout2d=False, resnet_p=0.01,
        rec_ae_resnet_type='18', rec_ae_nclasses=2,
        conv_ae_nclasses=2
    ):
        super().__init__()
        self.audio_model = ResNet(
            num_nodes=resnet_num_nodes,
            enc_dim=resnet_enc_dim,
            resnet_type=resnet_resnet_type,
            nclasses=resnet_nclasses,
            dropout1d=resnet_dropout1d,
            dropout2d=resnet_dropout2d,
            p=resnet_p)
        
        self.reconstruction_autoencoder = Reconstruction_autoencoder(
            enc_dim=rec_ae_enc_dim,
            resnet_type=rec_ae_resnet_type,
            nclasses=rec_ae_nclasses
            )
        
        self.conversion_autoencoder = Conversion_autoencoder(
            num_nodes=conv_ae_num_nodes,
            enc_dim=conv_ae_enc_dim,
