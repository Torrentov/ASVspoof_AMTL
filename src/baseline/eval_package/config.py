...
class ConfigLA_dev:
    ...
    def __init__(self):
        ...
        # =====
        # name of data series for procotol file
        self.p_names = ['spk', self.index_col, '-',
                        'attack', 'label', 'subset', 'codec']
        # name of data series for score file
        self.s_names = [self.index_col, self.score_col]
        
        # CM protocol path
        self.protocol_cm_file = 'LA_dev/CM/trial_metadata.txt'
        ...
        # =====
        # name of data series for procotol file
        self.p_names_asv = ['spk', self.index_col,
                            'attack', 'label', 'subset', 'codec']
        # name of data series for score file
        self.s_names_asv = ['asv_spk', self.index_col, self.score_col]

        # ASV protocol path
        self.protocol_asv_file = 'LA_dev/ASV/trial_metadata.txt'
        # ASV score by organizers
        self.pre_score_asv_file = 'LA_dev/ASV/score.txt'
        # flag, whether tDCF is applicable to this track 
        self.flag_tDCF = True
        ...
        # =====
        # C012 buffer
        self.c012_file = {'dev': 'LA_dev/LA-C012-eval.npy'}
